    ...
    return (
        <div className="bg-[#1D1D1D] text-white text-center">
            <div className="max-w-screen-xl mx-auto p-4">
                <h2 className="text-3xl font-semibold border-b-2 border-[#FEB000] md:w-2/6 mx-auto">Technologies and Tools</h2>
                ...
                <div className="grid grid-cols-3 md:grid-cols-6 my-6">
                    {
                        skills.map(skill => <div key={skill._id} className="p-4">
                            <img src={skill.image} className="w-40" alt="" />
                            <h4>{skill.title}</h4>
                        </div>)
                    }
                </div>
